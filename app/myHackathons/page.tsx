...
import { featuredHackathons, getDaysRemaining } from "@/lib/data"
import { Clock, Trophy, Target, Calendar, Users, Vote, Gavel, Code, Coins, CheckCircle, XCircle, Loader2, AlertCircle, RefreshCw, Wifi, WifiOff } from "lucide-react"
...
export default function MyHackathonsPage() {
  ...
  const renderParticipatingCard = (hackathon: HackathonData) => {
    ...
    return (
      <Card key={hackathon.id} className="border-0 shadow-lg hover:shadow-xl transition-shadow">
        <CardContent className="p-6">
          <div className="space-y-4">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <h3 className="text-xl font-bold mb-2">{hackathon.hackathonName}</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-yellow-600">{hackathon.prizePool} ETH</span>
              </div>
              <div className="flex items-center gap-2">
                <Vote className="w-4 h-4 text-purple-500" />
                <span className="text-sm text-muted-foreground">{userProject.tokensReceived} votes</span>
              </div>
              <div className="flex items-center gap-2">
                <Coins className="w-4 h-4 text-green-500" />
                <span className="text-sm text-muted-foreground">{userProject.estimatedPrize.toFixed(4)} ETH estimated</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
              <p className="text-sm font-semibold mb-1">Your Project #{userProject.id}</p>
              <p className="text-sm text-muted-foreground">{userProject.documentation}</p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-muted-foreground">Judge: {userJudge.name}</span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-muted-foreground">{tokenUsagePercent.toFixed(0)}% used</span>
              </div>
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-muted-foreground">
                  {status === 'active' ? `${getDaysRemaining(hackathon.endTime)} days left` : 
                   status === 'upcoming' ? 'Not started' : 
                   status === 'ended' ? 'Voting closed' : 'Concluded'}
                </span>
              </div>
              
              <div className="flex gap-2">
                {status === 'active' && userJudge.tokensRemaining > 0 && (
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-muted-foreground">{hackathon.totalTokens} total tokens</span>
              </div>
            </div>
    ...
    return (
      <div className="space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-lg">Track your hackathon participation, judging, and organizing activities</p>
    ...
    <div className="space-y-8">
      ...
      <div className="flex gap-4 justify-center">
        <Button 
          ...
          className={activeTab === "participating" ? "bg-amber-600 hover:bg-amber-700 text-white" : ""}
        >
        ...
        <Button 
          ...
          className={activeTab === "judging" ? "bg-amber-600 hover:bg-amber-700 text-white" : ""}
        >
        ...
        <Button 
          ...
          className={activeTab === "organizing" ? "bg-amber-600 hover:bg-amber-700 text-white" : ""}
        >
      ...
      {currentHackathons.length === 0 && (
        <div className="text-center py-12">
          <div className="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-4">
            {activeTab === "participating" && <Target className="w-8 h-8 text-gray-400" />}
            {activeTab === "judging" && <Gavel className="w-8 h-8 text-gray-400" />}
            {activeTab === "organizing" && <Users className="w-8 h-8 text-gray-400" />}
          </div>
